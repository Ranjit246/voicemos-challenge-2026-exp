...
# enriched SHARED space (used for both targets — shared beat per-target)
SHARED = [("ecapa", lambda k: ECAPA[k]), ("tita", lambda k: TITA[k]), ("wesp", lambda k: WESP[k]),
          ("cacc", lambda k: CACC[k]), ("w2va", lambda k: W2VA[k]),
          ("wl0", lambda k: wl(k, 0)), ("wl3", lambda k: wl(k, 3)),
          ("wl9", lambda k: wl(k, 9)), ("wl12", lambda k: wl(k, 12))]
SPK_SRC = SHARED
ACC_SRC = SHARED
